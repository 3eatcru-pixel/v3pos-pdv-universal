      ...
      <div className="space-y-6">
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
             ...
             <div>
               <h2 className="text-2xl font-black text-slate-800 tracking-tight">RelatÃ³rios de Desempenho</h2>
               <p className="text-sm text-slate-500 font-medium tracking-tight">AnÃ¡lise detalhada de vendas e produtividade</p>
             </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="sleek-card p-6 bg-emerald-500 text-white">
                  ...
                  <p className="text-[10px] mt-4 font-bold opacity-80 uppercase tracking-tight">Acumulado desde o inÃ­cio</p>
               </div>
               <div className="sleek-card p-6">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-1">Ticket MÃ©dio Geral</p>
               ...
               <div className="sleek-card p-6">
                  <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest mb-1">Melhor Dia (MÃ©dia)</p>
                  ...
                  <div className="mt-4 flex items-center gap-1 text-[10px]">
                    ...
                    <span className="font-medium text-slate-400">Baseado no histÃ³rico de vendas</span>
                  </div>
               </div>
            </div>
        ...
        {reportsTab === 'sales' && (
          <div className="sleek-card overflow-hidden">
            <div className="p-6 border-b border-slate-100 bg-slate-50/50">
              <h3 className="text-sm font-black uppercase text-slate-800 tracking-widest">DiÃ¡rio de Vendas Detalhado</h3>
            </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-100">
                    ...
                    <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">MÃ©todo</th>
                  </tr>
                </thead>
                  ...
                  {deliveredOrders.length === 0 && (
                    <tr>
                      <td colSpan={5} className="py-20 text-center opacity-30">
                        ...
                        <p className="text-xs font-black uppercase tracking-widest">Nenhuma venda encontrada no histÃ³rico</p>
                      </td>
                    </tr>
                  )}
                </tbody>
          ...
          <div className="space-y-6">
            ...
            {staff.length === 0 && (
              <div className="py-20 text-center opacity-30">
                 ...
                 <p className="text-xs font-black uppercase tracking-widest">Nenhum funcionÃ¡rio encontrado</p>
              </div>
            )}
          </div>
        )}
        ...
        {reportsTab === 'finance' && (
          <div className="space-y-6">
             ...
             <div className="sleek-card p-8 bg-white border-slate-100">
                ...
                <div className="space-y-6">
                   <CostBar label="Lucro LÃ­quido" value={netProfit} total={financeStats.revenue} color="bg-emerald-500" />
                   <CostBar label="Custos Operacionais (Insumos)" value={financeStats.cogs} total={financeStats.revenue} color="bg-slate-700" />
                   <CostBar label="Perda por DesperdÃ­cio" value={financeStats.wastage} total={financeStats.revenue} color="bg-red-500" />
                   <CostBar label="Descontos e PromoÃ§Ãµes" value={financeStats.discount} total={financeStats.revenue} color="bg-amber-500" />
                </div>
             </div>
          </div>
        )}
      ...
      <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4">
        ...
        >
          ...
          <div className="space-y-6">
               ...
               <div>
                 ...
                 <div className="grid grid-cols-1 gap-2">
                   {[
                     ...
                     { id: 'action', label: 'AÃ§Ã£o', icon: <Shield className="w-4 h-4" /> },
                   ].map(type => (
                     <button
                       key={type.id}
                       type="button"
            ...
            <div>
              <label htmlFor="incident-title" className="text-[10px] font-black uppercase text-slate-400 mb-2 block">TÃ­tulo da OcorrÃªncia</label>
              <input 
                id="incident-title"
                type="text" 
            ...
            <div>
              <label htmlFor="incident-desc" className="text-[10px] font-black uppercase text-slate-400 mb-2 block">DescriÃ§Ã£o Detalhada</label>
              <textarea 
                id="incident-desc"
                ...
                placeholder="Descreva o que aconteceu, consequÃªncias e possÃ­veis aÃ§Ãµes imediatas necessÃ¡rias."
              />
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <button 
                  ...
                  title="Usar localizaÃ§Ã£o do dispositivo"
                >
